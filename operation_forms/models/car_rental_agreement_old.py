...
class CarRentalAgreement(models.AbstractModel):
    ...
    vo_id = fields.Many2one(comodel_name="vehicle.order", string="Vo", required=False,compute='get_vo_vo_startDate_vo_endDate',store=True ,readonly=False)
    ...
    vo_start_date = fields.Date(related='vo_id.vo_start_date',compute='get_vo_vo_startDate_vo_endDate')
    vo_end_date = fields.Date(related='vo_id.vo_end_date',compute='get_vo_vo_startDate_vo_endDate')

    # mla_id = fields.Many2one(related="vo_id.mla_id", string='MLA',compute='get_vo_vo_startDate_vo_endDate')
    # mla_id = fields.Many2one(related="vo_id.mla_id", string='MLA',compute='get_vo_vo_startDate_vo_endDate')
    mla_id = fields.Many2one('mla.data', string='MLA',compute='get_vo_vo_startDate_vo_endDate')
    mla_start_date = fields.Date(related='mla_id.start_date',compute='get_vo_vo_startDate_vo_endDate')
    mla_end_date = fields.Date(related='mla_id.end_date',compute='get_vo_vo_startDate_vo_endDate')
