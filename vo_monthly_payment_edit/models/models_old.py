    ...
    def create_invoice_action(self):
        ...
        for rec in self:
            ...
            if rec.vehicle_id.extra_km > 0:
                ...
                print(f'in create_invoice_action - of millage.vehicle.payment -rec.vehicle_id.extra_km >0 =  product_obj :{product_obj}')
                account_move_vals = {
        ...
        for vo in self:
            ...
            for rec in vo.millage_car_details_ids:
                ...
                if rec.is_grouped == True and not rec.invoice_id:
                    ...
                    print(f'create_invoice_action_millage - product_extra before :{product_extra}')
                    ...
                    if vo.extra_km > 0:
                        ...
                        if vo.pool_millage != True:
                            ...
                            if vo.invoice_policy == 'grouped':
                                ...
                                if not there_is_km:
                                    print(
                                        f'in create_invoice_action_millage = case  not ttttttt22 invoice policy grouped = case extra lkmmmmmm2222  - not there_is_km: {there_is_km} ')
                                    # product_obj = self.env['product.product'].create(
                                    #     {'name': 'Extra KM', 'extra_km': True, 'detailed_type': 'service'})
